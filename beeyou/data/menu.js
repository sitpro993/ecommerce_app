...
export const menu = {
  menu: [
    ...
    },
    {
      ...
      link: "/collections/kiem-tra-don-hang",
    },
    {
      content: "Đồng Phục - Quà Tặng ",
      link: "/collections/dong-phuc-qua-tang",
    },
  ],
};
const products = [
  {
    title: "Túi totebag xương rồng",
    slug: "tui-totebag-xuong-rong",
    price: 120000,
    description: "tui đẹp vl",
    category: "beebag",
    variant: [
      {
        name: "màu xanh",
...
const product = [
  {
    ...
    price: 120000,
    description: "Ốp lưng đẹp vl",
    variant: [
      {
        title: "Ốp lưng XS Max",
        img: "link ảnh",
      },
      {
        title: "Ốp lưng iphone 7",
        img: "link ảnh",
      },
    ],
    size: ["X", "XL", "L", "S"],
    category: ["BeeCase", "Ốp lưng animal", "Ốp lưng con trai"],
    checked: true,
    sold: 10,
  },
];
