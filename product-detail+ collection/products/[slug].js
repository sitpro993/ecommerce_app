        ...
        <div className="details-product-single">
          ...
          <div className="box-detail">
            <div className="row">
              ...
              <p className="infor-details">
                Túi vải đeo chéo thời trang, chất vải canvas mềm mịn, không xù
                nhão; mẫu mã cập nhật xu hướng thị trường mới nhất. Bee đảm bảo
                chất lượng túi...
              </p>
            </div>
          ...
          <div className="detail-infor-ship">
            <div class="infor-ship-all">
              <p className="first">
                SẢN PHẨM NÀY SẼ TỚI TAY BẠN CHỈ TRONG 2-4 NGÀY LÀM VIỆC
              </p>
